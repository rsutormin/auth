...
//	private long expiry = 0;
	 ...
	 */
	public final long DEFAULT_EXPIRES = 3 * 24 * 60 * 60;
...
//	/**
//	 * Tests whether this token has expired or not.
//	 * It assumes that the expiry field is the number of seconds since the Epoch (UTC),
//	 * and compares that with the current time.
//	 *
//	 * @return true if the AuthToken has expired, false otherwise
//	 */
//	public boolean isExpired() {
